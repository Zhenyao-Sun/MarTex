...
python <(curl -s https://raw.githubusercontent.com/Zhenyao-Sun/MarTex/master/mdTreater.py) $MDFILE $MDDIR
...
# ...Modify the tex file...
python <(curl -s https://raw.githubusercontent.com/Zhenyao-Sun/MarTex/master/texTreater.py) $MDDIR
